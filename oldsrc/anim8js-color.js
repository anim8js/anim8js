...
m8.color.format = function(color)
{
  var ca = _coalesce(color.a, 1.0);
  var cr = _coalesce(color.r, 255);
  var cg = _coalesce(color.g, 255);
  var cb = _coalesce(color.b, 255);
