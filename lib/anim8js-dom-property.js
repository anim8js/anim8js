...
anim8.property.factory = function(nm, axis) 
{
  return {
    ...
    get: function(e, anim) 
    {
      if (anim.animating[nm] === false) 
      {
        ...
        var converted = anim8.convert( e, style, anim.unit( nm ), axis );
...
anim8.property.factoryDerivable = function(nm, axis, deriver) 
{
  return {
    ...
    get: function(e, anim) 
    {
      if (anim.animating[nm] === false) 
      {
        ...
        {
          converted = anim8.convert( e, deriver( e ), anim.unit( nm ), axis );
...
anim8.property.paddingTop               = anim8.property.factory( 'paddingTop', 'y' );
anim8.property.paddingRight             = anim8.property.factory( 'paddingRight', 'x' );
anim8.property.paddingBottom            = anim8.property.factory( 'paddingBottom', 'y' );
anim8.property.paddingLeft              = anim8.property.factory( 'paddingLeft', 'x' );

anim8.property.margin                   = anim8.property.factory( 'margin' );
anim8.property.marginTop                = anim8.property.factory( 'marginTop', 'y' );
anim8.property.marginRight              = anim8.property.factory( 'marginRight', 'x' );
anim8.property.marginBottom             = anim8.property.factory( 'marginBottom', 'y' );
anim8.property.marginLeft               = anim8.property.factory( 'marginLeft', 'x' );
...
anim8.property.borderTopWidth           = anim8.property.factory( 'borderTopWidth', 'y' );
anim8.property.borderRightWidth         = anim8.property.factory( 'borderRightWidth', 'x' );
anim8.property.borderBottomWidth        = anim8.property.factory( 'borderBottomWidth', 'y' );
anim8.property.borderLeftWidth          = anim8.property.factory( 'borderLeftWidth', 'x' );

anim8.property.outlineWidth             = anim8.property.factory( 'outlineWidth', 'x' );
anim8.property.textIndent               = anim8.property.factory( 'textIndent', 'y' );
anim8.property.borderSpacing            = anim8.property.factory( 'borderSpacing', 'x' );
anim8.property.fontSize                 = anim8.property.factory( 'fontSize' );
anim8.property.lineHeight               = anim8.property.factory( 'lineHeight', 'y' );
...
anim8.property.minWidth                 = anim8.property.factory( 'minWidth', 'x' );
anim8.property.maxWidth                 = anim8.property.factory( 'maxWidth', 'x' );
anim8.property.minHeight                = anim8.property.factory( 'minHeight', 'y' );
anim8.property.maxHeight                = anim8.property.factory( 'maxHeight', 'y' );

anim8.property.width                    = anim8.property.factoryDerivable('width', 'x', function(e) { return e.offsetWidth + 'px'; });
anim8.property.height                   = anim8.property.factoryDerivable('height', 'y', function(e) { return e.offsetHeight + 'px'; });
anim8.property.top                      = anim8.property.factoryDerivable('top', 'y', function(e) { return e.offsetTop + 'px'; });
anim8.property.right                    = anim8.property.factoryDerivable('right', 'x', function(e) { return (e.parentNode.scrollWidth - (e.offsetLeft + e.offsetWidth)) + 'px'; });
anim8.property.bottom                   = anim8.property.factoryDerivable('bottom', 'y', function(e) { return (e.parentNode.scrollHeight - (e.offsetTop + e.offsetHeight)) + 'px'; });
anim8.property.left                     = anim8.property.factoryDerivable('left', 'x', function(e) { return e.offsetLeft + 'px'; });
...
anim8.property.transformOrigin = (function() 
{
  ...
  var setOriginAttribute = function(e, value, anim, attr, axis ) 
  {
    if (anim.animating[attr] === false) 
    {
      ...
      var converted = anim8.convert( e, value, anim.unit( attr ), axis );
  ...
  var setOrigin = function(e, split, anim) 
  {
    if (anim.animating.origin === false) 
    {
      ...
      {     
        setOriginAttribute( e, split[0], anim, 'origin', 'x' );
      }            
    }
  };
  ...
  return {
    ...
    get: function(e, anim) 
    {
      ...
      if (style) 
      {
        ...
        {
        case 3:
          setOriginAttribute( e, split[0], anim, 'originX', 'x' );
          setOriginAttribute( e, split[1], anim, 'originY', 'y' );
          setOriginAttribute( e, split[2], anim, 'originZ', 'x' );
        ...
        case 1:
          setOriginAttribute( e, split[0], anim, 'originX', 'x' );
          setOriginAttribute( e, split[0], anim, 'originY', 'y' );
          setOrigin( e, split, anim );
          break;
        }
      }
...
anim8.property.transform = (function() 
{
  ...
  var parse = function( e, value, anim, attr, axis )
  {
    var desiredUnit = anim.unit( attr );
    var converted = anim8.convert( e, value, desiredUnit, axis );
      ...
      for (var attr in anim.animating) 
      {
        if ( anim.animating[ attr ] === false && attr in regex ) 
        {
          ...
          if ( parsed ) 
          {
            ...
            {
              anim.frame[attr] = {
                x: parse( e, parsed[1], anim, attr, 'x' ),
                y: parse( e, parsed[2], anim, attr, 'y' ),
                z: parse( e, parsed[3], anim, attr, 'x' ),
            ...
            {
              anim.frame[attr] = parse( e, parsed[1], anim, attr, 'x' );
            }
		...
		get: function(e, anim) 
    {
			...
			for (var attr in patterns) 
      {
				if ( anim.animating[attr] === false ) 
        {
					...
					if (parsed !== false) 
          {
            var converted = anim8.convert( e, parsed[1], anim.unit( attr ), 'x' );
...
anim8.property.center = 
{
  get: function(e, anim)
  {
    ...
    if ( anim.animating.center === false )
    {
      ...
      var ccx = anim8.convert( e, cx, desiredUnit, 'x' );
      var ccy = anim8.convert( e, cy, desiredUnit, 'y' );
